...
```{r}
case_one_raw <- read_csv("../data/case_study_1_data_july_24_2025.csv")
```
...
```{r}
gdp_raw <- read_csv("../data/dataset_2025-07-24T18_28_31.898465539Z_DEFAULT_INTEGRATION_IMF.RES_WEO_6.0.0.csv")
```
```{r}
head(gdp_raw)
```
