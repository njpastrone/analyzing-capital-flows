...
def main(context="standalone"):
    ...
    **CV Ratio Summary (Iceland/Eurozone):**
    ...
    # 📥 Download Individual Time Series Charts
    st.subheader("📥 Download Individual Time Series Charts")
    time_series_figures = []
    n_cols_download = 3
    ...
    for batch_idx in range(0, n_indicators, n_cols_download):
        ...
        for col_idx, indicator in enumerate(batch_indicators):
            ...
            # Content displayed for PDF export
            plt.close(fig_ind)
...
def case_study_1_outlier_adjusted_main_crisis_excluded(context="standalone"):
    ...
    **Individual Country Analysis Summary (Crisis-Excluded):**
    ...
    # Create individual figures for detailed downloads
    # 📥 Download Individual Time Series Charts (Crisis-Excluded)
    st.subheader("📥 Download Individual Time Series Charts (Crisis-Excluded)")
    n_cols_download = 3
