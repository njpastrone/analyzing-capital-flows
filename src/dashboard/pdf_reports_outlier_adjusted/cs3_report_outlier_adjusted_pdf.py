...
def case_study_3_outlier_adjusted_main_crisis_excluded(context="standalone"):
    ...
    **Enhanced Analysis:** Comparing Iceland to each individual small open economy separately,
    ...
    st.markdown("""
    **Complete outlier-adjusted analysis results are displayed above in the comprehensive tables and visualizations.**
    
    This crisis-excluded analysis using winsorized data provides insights into normal market volatility patterns by removing 
    both periods of exceptional global financial stress (2008-2010 GFC and 2020-2022 COVID-19) and extreme outlier values.
    """)
