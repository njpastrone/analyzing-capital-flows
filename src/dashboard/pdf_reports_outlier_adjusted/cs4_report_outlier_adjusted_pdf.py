"""
Case Study 4: Comprehensive Statistical Analysis Report Application (Outlier-Adjusted)

Professional dashboard for CS4 analysis comparing Iceland vs multiple comparator groups using winsorized data.
...
def display_comprehensive_analysis_overview(full_results, crisis_results):
    ...
    **Interpretation:** Half-life indicates shock persistence in quarters. Lower values (green) show faster 
    ...
    # PDF Report: Download buttons removed for clean PDF export
    
    # Individual chart information section
...
def display_summary_insights_and_export(full_results, crisis_results):
    ...
    st.info("📊 **Complete Analysis Summary:** All master tables have been processed and are displayed above for PDF export compatibility.")
...
def main(standalone=False):
    ...
    st.title("🛡️ 🇮🇸 Case Study 4: Comprehensive Statistical Analysis (Outlier-Adjusted)")
    st.markdown("""
