"""
Capital Flows Analysis - Case Study 3: Iceland vs SOEs Report
...
def main():
    ...
    st.title("🇮🇸 Comparative Analysis: Iceland and SOEs")
    ...
    **Key Hypothesis:** Iceland and other small open economies may exhibit different capital flow volatility patterns despite similar economic structures and currency regimes.
    ...
    - **Countries:** Iceland vs 6 SOEs (Aruba, Bahamas, Brunei Darussalam, Malta, Mauritius, Seychelles)
...
def case_study_3_main(context="standalone"):
    ...
    st.markdown("""
    **Enhanced Analysis:** Rather than comparing Iceland to SOEs as an aggregate group, 
    this section compares Iceland's values to each individual SOE separately.
    """)
...
def case_study_3_main_crisis_excluded(context="standalone"):
    ...
    st.markdown("""
    **Enhanced Analysis:** Comparing Iceland to each individual SOE separately,
    ...
    # Results summary section (Crisis-Excluded) - PDF optimized without downloads
    st.markdown("---")
    st.header("6. Analysis Summary (Crisis-Excluded)")
    
    st.markdown("""
    **Complete analysis results are displayed above in the comprehensive tables and visualizations.**
    
    This crisis-excluded analysis provides insights into normal market volatility patterns by removing 
    periods of exceptional global financial stress (2008-2010 GFC and 2020-2022 COVID-19).
    """)
    
    col1, col2, col3, col4 = st.columns(4)
    
    with col1:
        st.info("📊 **Summary Statistics**\nDisplayed in Section 4 tables above")
    
    with col2:
        st.info("📈 **Statistical Tests**\nF-test results shown in analysis sections")
    
    with col3:
        st.info("📋 **Group Comparisons**\nComprehensive results in visualizations above")
    
    with col4:
        st.info("📝 **Complete Analysis**\nAll results integrated in this report")
